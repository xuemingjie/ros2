...
class Nav_Goal(metaclass=Metaclass_Nav_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.goal_thrta = kwargs.get('goal_thrta', float())
    ...
    def __eq__(self, other):
        ...
        if self.goal_y != other.goal_y:
            return False
        if self.goal_thrta != other.goal_thrta:
            return False
        return True
    ...
    @builtins.property
    def goal_thrta(self):
        """Message field 'goal_thrta'."""
        return self._goal_thrta

    @goal_thrta.setter
    def goal_thrta(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'goal_thrta' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'goal_thrta' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._goal_thrta = value
