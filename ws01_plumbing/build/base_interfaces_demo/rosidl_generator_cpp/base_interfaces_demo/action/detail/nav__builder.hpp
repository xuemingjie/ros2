...
class Init_Nav_Goal_goal_thrta
{
public:
  explicit Init_Nav_Goal_goal_thrta(::base_interfaces_demo::action::Nav_Goal & msg)
  : msg_(msg)
  {}
  ::base_interfaces_demo::action::Nav_Goal goal_thrta(::base_interfaces_demo::action::Nav_Goal::_goal_thrta_type arg)
  {
    msg_.goal_thrta = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Nav_Goal_goal_thrta goal_y(::base_interfaces_demo::action::Nav_Goal::_goal_y_type arg)
  {
    msg_.goal_y = std::move(arg);
    return Init_Nav_Goal_goal_thrta(msg_);
  }
